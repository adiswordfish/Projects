...
from updatecontinue import updateing
...
class Update(Toplevel):
    def __init__(self):
        ...
        note = Label(self.bottom, text="Enter All given items of contact you want to update ", font="arial 15 bold", fg="white", bg="#ebb434")
        ...
        button = Button(self.bottom, text="Continue Update Contact", command=update)
